    ...
    <section id='about' className='py-5'>
      <div className='container mx-auto max-w-6xl px-4'>
        ...
        >
          ...
          >
            <p className='text-lg'>
              <span className='text-4xl'>Hi!</span> I'm a passionate Full Stack
              Developer with expertise in both frontend and backend
              technologies. I specialize in building robust applications using
              Spring Boot for backend services and React for dynamic frontend
              interfaces.
            </p>
            <p className='text-lg'>
            ...
            >
              ...
              <div className='grid gap-4 sm:grid-cols-2'>
                <motion.div
                  ...
                  className='glow-effect rounded-xl border border-white/10 p-4'
                >
          ...
          <motion.div
            ...
            className='glow-effect group relative'
          >
            <div className='rounded-xl border border-white/10 bg-gray-800/50 p-6 shadow-xl backdrop-blur-sm'>
              <div className='flex flex-col items-center space-y-4'>
                <motion.div
                  ...
                  transition={{ type: 'spring', stiffness: 300 }}
                  className='glow-effect relative h-48 w-48 overflow-hidden rounded-full border-4 border-white/10'
                >
                  <Image
                    src={image}
                    alt='Your Name'
                ...
                >
                  <motion.a
                    ...
                    className='glow-effect text-gray-300 hover:text-white'
                    target='_blank'
                  ...
                  >
                    <span className='sr-only text-white'>Download Resume</span>
