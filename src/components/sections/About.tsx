    ...
    <section id='about' className='py-5'>
      <div className='container mx-auto max-w-6xl px-4'>
        ...
        >
          ...
          className='rounded-xl border border-white/10 p-4 glow-effect'
            >
        ...
        <div className='rounded-xl border border-white/10 bg-gray-800/50 p-6 shadow-xl backdrop-blur-sm'>
          ...
          transition={{ type: "spring", stiffness: 300 }}
          className='relative h-48 w-48 overflow-hidden rounded-full border-4 border-white/10 glow-effect'
            >
          <Image
            src={image}
            alt='Your Name'
          ...
          <motion.a
            ...
            className='text-gray-300 hover:text-white glow-effect'
            target='_blank'
